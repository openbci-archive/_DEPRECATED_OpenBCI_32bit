...
//------------------------------------------------------------------------------
/** List directory contents to Serial0.
 *
...
void SdFile::ls(uint8_t flags, uint8_t indent) {
  ...
  while ((p = readDirCache())) {
    ...
    for (int8_t i = 0; i < indent; i++) Serial0.print(' ');
...
//------------------------------------------------------------------------------
/** %Print the name field of a directory entry in 8.3 format to Serial0.
 *
 * \param[in] dir The directory structure containing the name.
...
//------------------------------------------------------------------------------
/** %Print a directory date field to Serial0.
 *
...
void SdFile::printFatDate(uint16_t fatDate) {
  Serial0.print(FAT_YEAR(fatDate));
  Serial0.print('-');
...
//------------------------------------------------------------------------------
/** %Print a directory time field to Serial0.
 *
 * Format is hh:mm:ss.
 *
...
//------------------------------------------------------------------------------
/** %Print a value as two digits to Serial0.
 *
